      ...
      <div className="container mx-auto px-[8px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md flex flex-col justify-between">
            <div className="mb-2">
              <h3 className="text-xl font-semibold text-cps-blue-dark mb-2">Como chegar</h3>
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <Button 
                  className="bg-cps-blue-dark text-white hover:bg-cps-blue-dark/90 flex items-center justify-center h-11" 
                ...
                <Button 
                  className="bg-cps-blue-light text-white hover:bg-cps-blue-light/90 flex items-center justify-center h-11" 
              ...
              {/* Botão de sugestão de restaurantes */}
              <Button 
                className="bg-cps-wine text-white hover:bg-cps-wine/90 w-full flex items-center justify-center h-11" 

                        ...
                        <div className="flex items-center gap-4 mt-2">
                          <div className="relative group">
                            <a 
                              ...
                              target="_blank" 
                              rel="noopener noreferrer"
                              className="text-cps-wine font-medium inline-flex items-center justify-center p-2 rounded-full hover:bg-cps-wine/10 transition-all duration-300 transform hover:scale-110"
                              aria-label="Instagram da Agência Reconheça"
                            >
                              <Instagram className="h-6 w-6" />
                              <span className="sr-only">Instagram da Agência Reconheça</span>
                            </a>
                            <div className="absolute -bottom-10 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap pointer-events-none z-10">
                              Instagram @reconhecasp
                            </div>
                          </div>
                          <div className="relative group">
                            <a 
                            ...
                            >
                              ...
                              <span className="sr-only">TikTok da Agência Reconheça</span>
                            </a>
                            <div className="absolute -bottom-10 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap pointer-events-none z-10">
                              TikTok @reconhecasp
                            </div>
